...
function executer_requete_update($requete) {
    ...
    if($res == FALSE){
        echo "<p>Erreur: Requéte non exécutée !</p>";
        return 0;
    } else {
        $rows_affected = mysqli_affected_rows($connexion);
        return ($rows_affected > 0) ? 1 : 0;
    }
}


function executer_une_requete2( $requete ) {
